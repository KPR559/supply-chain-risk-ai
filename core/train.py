...
Usages::
    ...
    python -m core.train                 # full: data -> features -> train both models
...
def cmd_train(version: str = "1.0.0", groups=None, use_xgboost: bool = True) -> dict:
    ...
    from core.models import classification, delay
...
def cmd_eval() -> dict:
    ...
    from core.evaluate import calibration
